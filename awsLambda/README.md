...
4. [Copy snapshot to another region](https://github.com/MederD/AWS_playground/blob/main/awsLambda/copy_snap.py)  
5. [Taking snapshot of volumes with matching tags](https://github.com/MederD/AWS_playground/blob/main/awsLambda/snapshots.py)   
6. [Revoke wide open ports](https://github.com/MederD/AWS_playground/blob/main/awsLambda/revokeOpenPorts.py) 
