...
APPLICABLE_RESOURCES = ["AWS::ECS::Cluster", "AWS::ECS::TaskDefinition"]
ClientName = 'ecs'
...
def evaluate_compliance(configuration_item, rule_parameters):
    ...
    if configuration_item["resourceType"] == "AWS::ECS::Cluster" or configuration_item["resourceType"] == "AWS::ECS::TaskDefinition":
        current_tags = configuration_item['tags']
        # client = boto3.client(ClientName)
        # all_tags = client.list_tags_for_resource(resourceArn = configuration_item["ARN"])
